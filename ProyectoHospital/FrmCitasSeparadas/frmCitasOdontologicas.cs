...
{
    public partial class frmCitasOdontologicas : Form
    {
        public frmCitasOdontologicas()
        {
            InitializeComponent();
        }

        private void frmCitasOdontologicas_Load(object sender, EventArgs e)
        {
            ...
            "Data Source=DESKTOP-F; Initial Catalog=Proyecto;Integrated Security=true"))
            {
                ...
                string query = "SELECT * FROM sacarCitaOd";
