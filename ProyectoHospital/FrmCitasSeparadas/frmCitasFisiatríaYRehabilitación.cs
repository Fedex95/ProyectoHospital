...
{
    public partial class frmCitasFisiatríaYRehabilitación : Form
    {
        public frmCitasFisiatríaYRehabilitación()
        {
            InitializeComponent();
        }
        ...
        private void frmCitasFisiatríaYRehabilitación_Load(object sender, EventArgs e)
        {
            ...
            "Data Source=DESKTOP-F; Initial Catalog=Proyecto;Integrated Security=true"))
            {
                ...
                string query = "SELECT * FROM sacarCitaFisio";
