...
{
    public partial class frmCitasLaboratorio : Form
    {
        public frmCitasLaboratorio()
        {
            InitializeComponent();
        }

        private void frmCitasLaboratorio_Load(object sender, EventArgs e)
        {
            ...
            "Data Source=DESKTOP-F; Initial Catalog=Proyecto;Integrated Security=true"))
            {
                ...
                string query = "SELECT * FROM sacarCitaLb";
