...
{
    public partial class frmvFisiatríaYRehabilitación : Form
    {
        public frmvFisiatríaYRehabilitación()
        {
            InitializeComponent();
        }
        ...
        private void btnAceptar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                ProyectoHospital.DAO.CitasDAOFs objCita = new ProyectoHospital.DAO.CitasDAOFs();
        ...
        private void frmvFisiatríaYRehabilitación_Load(object sender, EventArgs e)
        {
